  ...
  <div id="app" class="clear_bor">
    <div class="ds-nav-left" v-if="!(urlPath==='/login' || urlPath==='/register')">
      <div class="contener-box">
        ...
        <div class="contener-box">
          <div class="ds-zx-user">在线：222</div>
        </div>
      </div>
    </div>
    <div :class="(urlPath==='/login' || urlPath==='/register')?'':'ds-nav-right'">
      ...
      >
        ...
        <div class="float_right">
          <ul class="ds-right-nav-icon">
            ...
            <li
              class="ds-right-nav-icon-get ds-icon-top-6"
              @click="changePasswordOld('修改取款密码',1)"
              title="修改取款密码"
            ></li>
            <li
              class="ds-right-nav-icon-get ds-icon-top-7"
      ...
      <!--withdrawal-->
      <withdrawal
        @showWithdrawal="toshowWithdrawal"
        :withdrawalShow="wShow"
        :infoArrs="infoWithdrawal"
        :wType="wTypea"
      ></withdrawal>
      <!--history-->
